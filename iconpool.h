/////////////////////////////////////////////////////////////////////////////
// Name:        iconpool.h
// Purpose:     SVG icon library + access methods
//              (svg icons from www.iconset.io)
// Author:      Jan Buchholz
// Created:     2025-11-17
/////////////////////////////////////////////////////////////////////////////
...
static const std::map<QString, const char *> pool {
...
class IconPool {
public:
    static std::optional<const char *> getSVGIconByName(const QString &name) {
    ...
    static QStringList getIconNamesAll() {
        QStringList names{};
    ...
    static std::string makeSVGVariant(const char *svg, IconState state) {
        std::string s(svg);
        switch (state) {
            ...
            case IconState::Disabled: {
                ...
                auto pos = s.find("<svg");
                if (pos != std::string::npos) {
                    s.insert(pos + 4, " style=\"opacity:0.4\"");
                }
                break;
            }
        }
